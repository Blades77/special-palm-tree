...
import first.iteration.endlesscreation.dto.Update.BookReviewUpdate;
...
public class BookReviewService {
    ...
    public List<BookReviewDTO> getBookReviewsByBookIdOrderByDate(String order, Long bookId){
        ...
        if(order.equals("asc")) {
            ...
            throw new InvalidPathVariableExpection("Invalid search type, should be \"asc\" or \"dsc\".");
        }
        return BookReviewMapper.mapToBookReviewDTOLIst(bookReviewEntityList);
    }
    ...
    public void updateBookReview(BookReviewUpdate bookReviewUpdate){
        BookReviewEntity bookReviewEntity = bookReviewDAO.getBookReviewEntity(bookReviewUpdate.getReviewId());
        bookReviewEntity.setReviewContent(bookReviewUpdate.getReviewContent());
        bookReviewUpdate.setReviewContent(bookReviewUpdate.getReviewContent());
        bookReviewRepository.save(bookReviewEntity);
    }
